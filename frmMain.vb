...
#End Region
    ...
    Private Function CorrectMETE(ByVal inME As String, ByVal inTE As String, ByRef METextBox As MetroFramework.Controls.MetroTextBox, ByRef TETextBox As MetroFramework.Controls.MetroTextBox) As Boolean
